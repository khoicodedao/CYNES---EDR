...
import { OrderedListOutlined, ControlOutlined } from "@ant-design/icons";
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className=" mb-6 flex flex-col gap-1.5">
                  ...
                  return (
                    <React.Fragment>
                      <div className="dashboard">
                        <Popover placement="right" title="Dashboard">
                          <Link
                            href="/"
              ...
              {/* <!-- Menu Item Event --> */}
              <li>
                <Popover placement="right" title={"Events"}>
                  <Link
                    href="/events"
              ...
              <li>
                <Popover placement="right" title={"Alerts"}>
                  <Link
                    href="/alerts"
                    className={`group relative fit-content flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
              ...
              {/* <!-- Menu Item Agent --> */}
              <li>
                <Popover placement="right" title={"Agents"}>
                  <Link
                    href="/agents"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              {/* <!-- Menu Item Task --> */}
              <li>
                <Popover placement="right" title={"Tasks"}>
                  <Link
                    href="/tasks"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
              ...
              <li>
                <Popover placement="right" title={"List Command"}>
                  <Link
                    href="/list-command"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname.includes("list-command") &&
                      "bg-graydark dark:bg-meta-4"
                    }`}
                  >
                    <OrderedListOutlined width={20} height={20} />
                    {sidebarOpen && "List Command"}
                  </Link>
                </Popover>
              </li>
              <li>
                <Popover placement="right" title={"Control Directly"}>
                  <Link
                    href="/control-directly"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname.includes("control-directly") &&
                      "bg-graydark dark:bg-meta-4"
                    }`}
                  >
                    <ControlOutlined />
                    {sidebarOpen && "Control Directly"}
                  </Link>
                </Popover>
              </li>
              <li>
                <Popover placement="right" title={"Group"}>
                  <Link
                    href="/group"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Popover placement="right" title={"Database"}>
                  <Link
                    href="/database"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
