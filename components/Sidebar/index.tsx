                        ...
                        <>
                          <ul className=" flex flex-col  ">
                            <li>
                              <Link
                                href="/list-command"
                                className={` pt-1 border-b-2 border-black-500 group relative flex items-center gap-2.5 rounded-md  font-medium text-bodydark2 duration-300 ease-in-out  ${
